                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6">
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                {formik.errors.id ? <small id="nameError" className="error form-text text-muted error "> {}</small>: null}
                                                            </div>
                                                            <div className="form-group">
                                                                ...
                                                                {formik.errors.date ? <small id="nameError" className="error form-text text-muted error "> {}</small>: null}
                                                            </div>
                                                            <div className="form-group">
                                                                ...
                                                                {formik.errors.password ? <small id="nameError" className="error form-text text-muted error "> {}</small>: null}
                                                            </div>
                                                            <div className="form-group">
